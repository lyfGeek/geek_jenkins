...
<%
    ...
    // 获取当前站点所需要的 cookie: ckUseCookie, ckCid。
    ...
    // 如果 ckUseCookie = on 并且当前的 currentCid 为空，则尝试提交相应的请求。
...
<%
    ...
    String thisPageleftMenuOpen = "root"; // 设定 left 页中的打开状态下拉菜单。
    String thisPageleftMenu = "menuList"; // 设定 left 页中的菜单箭头标注位置。
