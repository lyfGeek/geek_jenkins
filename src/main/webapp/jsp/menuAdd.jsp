<%@ page import="com.geek.model.Category" %>
<%@ page import="com.geek.service.CategoryManager" %>
...
<%
    ...
    String thisPageleftMenuOpen = "adControl";// 设定 left 页中的打开状态下拉菜单。
    String thisPageleftMenu = "addMenu";// 设定 left 页中的菜单箭头标注位置。
            ...
            <div class="col-xs-12">
                <form class="form-horizontal" role="form" action="/saveMenu" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-2" placeholder="菜名" class="col-xs-10 col-sm-5"
                                   name="mname"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-2" placeholder="价钱" class="col-xs-10 col-sm-5"
                                   name="price"/>
                        </div>
                    </div>
                    <div class="form-group">
